...
def render_llm_markdown_context(normalized: NormalizedDrawing) -> str:
    ...
    lines.extend(
        [
            ...
            "Не пиши «кандидат на отверстие», если у Ø есть допуск +0,1 или посадка.",
            "Фаски/скругления относи к наружному контуру или внутренней системе; спецэлементы — только группы отверстий, пазы, резьба.",
            "Числа ГДТ 0,02/0,03/0,05 формулируй как полное радиальное/торцевое биение относительно базы А; не используй 0,1/0,17 из таблиц допусков как ГДТ.",
            "Не подменяй габарит обозначением чертежа; для H/L/D*/d1* используй таблицу исполнений из Overall.",
            "Длины ступеней и габаритную длину включай в наружный контур; количество фасок указывай явно.",
            "Локальные Ra пиши у поверхностей в разделе геометрии; общую Ra — в примечаниях.",
        ]
    )
